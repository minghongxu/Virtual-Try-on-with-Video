...
class AnimationDataset(BaseDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        # parser.add_argument('--n_frames_total', type=int, default=1, help='the overall number of frames in a sequence to train with') 
        ...
        # parser.add_argument('--total_test_frames', type=int, default=1, help='the overall number of frames to load every sequence when test')
    ...
    def init_frame_idx(self, A_paths):
        ...
        # zhix
        # self.opt.total_test_frames = 1
        # self.opt.n_frames_pre_load_test = 1
        # self.n_frames_pre_load = 1
        # end
